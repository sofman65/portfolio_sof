    ...
    <section id="about" className="AboutMe">
      <div className="AboutMeContainer">
        ...
        <div className="AboutMeSkills">
          ...
          <p>
            Proficient in Python, SQL, and several other programming languages, with extensive experience in developer
            tools such as Git and Anaconda Jupyter Notebook. My expertise also spans a broad array of libraries,
            including Tensorflow-Keras, Pandas, and Scikit-learn.
          </p>
        </div>
